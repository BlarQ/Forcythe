...
const Footer = () => {
    ...
    return (
        <div className='py-14 px-[112px]'>
            ...
            <div className='flex flex-col gap-4 w-[35%]'>
                ...
                <div className=''>
                    <label className="flex items-center gap-4 cursor-pointer">
                        ...
                        />
                        <span
                            className={`w-6 h-5 border-2 rounded-full transition-all duration-200 
            ...
            <div className='w-[60%] flex flex-col gap-8 px-24'>
            ...
            <hr className='border-[#60a6e7]' />

            <p className='text-[#aea9b1] text-sm font-semibold py-4'>Copyright © {new Date().getFullYear()} Forcythe. All rights reserved.</p>
        </div>
    )
}
